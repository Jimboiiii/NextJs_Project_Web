    ...
    <div className="sticky top-0 z-50">
      <div className="bg-white shadow-[0_4px_10px_rgba(0,0,0,0.1)] relatve h-fit">
        <div className="flex flex-wrap items-center mx-auto py-2 px-8 justify-between">
          <button onClick={toggleUsersMenu} className={`item-center cursor-pointer md:p-0 ${showUsers ? "text-[#4267B2]" : "text-gray-500"}`}>
          ...
          <Link
            href="/"
            prefetch
            className={`text-lg font-extrabold md:p-0 ${pathname === "/" ? "text-[#4267B2]" : " text-gray-500 cursor-pointer"}`}
          >
            Posts
          </Link>
          ...
          <div className="relative flex items-center space-x-3">
            <div className='relative'>
              <button onClick={toggleProfileMenu} className={`flex cursor-pointer text-sm  rounded-full ${menuOpen ? "bg-[#4267b2]" : "bg-gray-500"}`}>
            ...
            return (
              <li key={user.id} className="">
                ...
                <button
                  ...
                  className={`cursor-pointer w-full px-5 py-2.5 relative inline-flex items-center justify-left overflow-hidden text-sm font-medium group  active:bg-[#4267b2] hover:bg-[#4267b2]  hover:text-white focus:outline-none ${selectedUser === user.name 
